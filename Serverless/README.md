...
The Serverless project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
...
Mounting ivyzhangAWS.StreamLambdaHandler::handleRequest (java8) at http://127.0.0.1:3000/{proxy+} [OPTIONS GET HEAD POST PUT DELETE PATCH]
...
```
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "ServerlessApi",  
                    "OutputKey": "ServerlessApi",
